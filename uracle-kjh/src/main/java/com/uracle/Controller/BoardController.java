...
public class BoardController {
	...
	public String list(UserVo ve,Model model, HttpSession session, HttpServletRequest request) {
	...
	public String detail(@RequestParam("id") int id,UserVo ve,BoardVO boardVO, Model model,HttpSession session,HttpServletRequest request) {
		HttpSession htpSession=request.getSession(true);
		UserVo Swriter=(UserVo)htpSession.getAttribute("login");
		session.setAttribute("login",Swriter);
